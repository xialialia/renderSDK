...
| job_info | 自定义类型或 RayvisionJob |  Y   | 查看[SDK内部使用文档](http://10.60.96.165/script/renderSDK/blob/master/doc/SDK%E5%86%85%E9%83%A8%E4%BD%BF%E7%94%A8%E6%96%87%E6%A1%A3.md)或单独使用时查看[示例](#-二、使用方法)                        |
